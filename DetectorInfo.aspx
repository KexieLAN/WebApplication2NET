<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetectorInfo.aspx.cs" Inherits="WebApplication2NET.DetectorInfo" %>
...
<nav class="navZone">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="detype" HeaderText="探测器类型" SortExpression="detype">
            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
            ...
            <asp:BoundField DataField="temperaturer" HeaderText="温度" SortExpression="temperaturer" >
            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
            ...
            <asp:BoundField DataField="VOC" HeaderText="VOC" SortExpression="VOC" >
            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
            <asp:BoundField DataField="smoke" HeaderText="烟雾" SortExpression="smoke" >
            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
        </Columns>
