<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BugInfo.aspx.cs" Inherits="WebApplication2NET.BugInfo" %>
...
<nav class="navZone">
    ...
    <asp:HyperLink CssClass="sub" ID="HyperLink_ERRORS" runat="server" Font-Bold="True" NavigateUrl="~/BugInfo.aspx" Width="100px">错误信息</asp:HyperLink>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="device_type" HeaderText="设备类型" SortExpression="device_type" NullDisplayText="N/A" >
            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
            <asp:BoundField DataField="device_number" HeaderText="设备编号" SortExpression="device_number" NullDisplayText="N/A" >
            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
            <asp:BoundField DataField="bug_code" HeaderText="错误代码" SortExpression="bug_code" NullDisplayText="N/A" >
            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
        </Columns>
