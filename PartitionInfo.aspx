...
<nav class="navZone">
    ...
    <asp:SqlDataSource ID="SqlDataSourceBugInfo" runat="server" ConnectionString="<%$ ConnectionStrings:MySerConnectionString %>" SelectCommand="SELECT * FROM [PartitionInfo]"></asp:SqlDataSource>
            <asp:Timer ID="TimerparInfo" runat="server" Interval="6000">
            </asp:Timer>
        </ContentTemplate>
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="GridView1" EventName="PageIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="TimerparInfo" EventName="Tick" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceBugInfoHis" runat="server" ConnectionString="<%$ ConnectionStrings:MySerConnectionString %>" SelectCommand="SELECT * FROM [PartitionInfo_History]"></asp:SqlDataSource>
            <asp:Timer ID="TimerparInfoHis" runat="server" Interval="6000">
            </asp:Timer>
        </ContentTemplate>
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="GridView2" EventName="PageIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="TimerparInfoHis" EventName="Tick" />
